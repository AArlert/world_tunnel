...
| `usgs_all_day.json` | `https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_day.geojson` | 2026-07-20T14:18:40Z | `curl -sS -A "world_tunnel-qa-fixture-fetch/1.0" "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_day.geojson" -o usgs_all_day.json` | 136380 | SPEC-5.1（启动回填） |
